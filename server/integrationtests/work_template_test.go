...
func TestGetTemplatesForWorkTemplate(t *testing.T) {
	// map[name]trackingTemplateId (SHA256 hashes of the imported template title).
	// Titles ending with " (NEW)" have that suffix stripped on import (see fixTemplateBoard),
	// leaving a trailing space. If any entry is missing, sync with the channels team.
	knownInWorkTemplates := map[string]string{
		...
		"Content Calendar ":      "8bce0fc36def13616cf782888fd136f93e8d4ddaec1c4e891801309629cd78e5",
		...
		"Personal Tasks ":        "1f7557fe6814c1aa091f7734f8d4f385576c7a34a16a1448e68e4efd4408be30",
