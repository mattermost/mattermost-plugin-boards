...
func SetupMattermostTablesForIntegration(db *sql.DB, dbType string) error {
	if err := setupChannelsTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupChannelMembersTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupTeamMembersTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupTeamsTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupUsersTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupPreferencesTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupBotsTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupFileInfoTableForIntegration(db, dbType); err != nil {
		return err
	}
	if err := setupSessionsTableForIntegration(db, dbType); err != nil {
		return err
	}
	return nil
}

func setupChannelsTableForIntegration(db *sql.DB, dbType string) error {
...
func setupChannelMembersTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupTeamMembersTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupTeamsTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupUsersTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupPreferencesTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupBotsTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupFileInfoTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
...
func setupSessionsTableForIntegration(db *sql.DB, dbType string) error {
	var createTableSQL string
	switch dbType {
	case model.PostgresDBType:
		createTableSQL = `
