...
4. **Автоматическая сборка**
   ...
   - Соберет плагин для всех платформ (Linux, macOS, Windows)
...
- **Содержимое:** Готовый плагин для установки в Mattermost на любой платформе
- **Совместимость:** Работает автоматическое обновление через Mattermost UI
...
**Примечание:** Для работы автоматического обновления bundle должен содержать все платформы (что и делает наш workflow).
